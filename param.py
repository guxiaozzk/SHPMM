...
parser.add_argument("--dataset", type=str, default='mvsa-s')
...
# parser.add_argument("--prompt_token", type=str, default='<unk>')
...
# parser.add_argument("--img_token", type=str, default='-')
parser.add_argument("--img_token_len", type=int, default=3)

parser.add_argument("--data_dir", type=str, default='datasets')
parser.add_argument("--img_dir", type=str,default='MVSA_A_data')
