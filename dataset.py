...
class MSADataset(Dataset):
    def __init__(self, args, processor, mode='train', max_seq_length=128):
        ...
        # self.tokenizer = RobertaTokenizer.from_pretrained(args.model_name, local_files_only=True)
...
#         print(self.prompt_shape)
#         print(input_tokens)
#         print( self.prompt_img_len)
